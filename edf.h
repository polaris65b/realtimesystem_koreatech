...
#define IDLE_TASK_ID 1023	//Just a number I assigend
#define ALL		1
#define CURRENT		0
...
float cpu_util(task *t1, int n);				//Calculates CPU utiliztion
...
int min(task *t1, int n, int p);				//Find minimum of given task paraemter
